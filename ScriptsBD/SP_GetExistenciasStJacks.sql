...
GO
IF OBJECT_ID('SP_GetExistenciasStJacks', 'P') IS NOT NULL
	DROP PROC dbo.SP_GetExistenciasStJacks
GO
CREATE PROCEDURE dbo.SP_GetExistenciasStJacks
AS
BEGIN
	SELECT 
		t.BodegaId,
...
EXEC EdiDb.dbo.SP_GetExistenciasStJacks